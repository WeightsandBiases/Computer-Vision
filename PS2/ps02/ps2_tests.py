...
def check_result(label, coords, ref, tol):
    assert abs(coords[0] - ref[0]) <= tol and abs(coords[1] - ref[1]) <= tol, (
        "Wrong coordinate values. "
        "Image used: {}. "
        "Expected: ({}, {}), "
        "Returned: ({}, {}). "
        "Max tolerance: {}."
        "".format(label, ref[0], ref[1], coords[0], coords[1], tol)
    )
...
class TestTrafficLight(unittest.TestCase):
    ...
    def test_simple_tl(self):
        tl_images = {
            "simple_tl_test": {"x": 45, "y": 120, "state": "green"},
            "tl_green_299_287_blank": {"x": 287, "y": 299, "state": "green"},
            "tl_red_199_137_blank": {"x": 137, "y": 199, "state": "red"},
            "tl_yellow_199_237_blank": {"x": 237, "y": 199, "state": "yellow"},
        }
        ...
        for tl in tl_images:
            ...
            test_image = cv2.imread("input_images/test_images/" "{}.png".format(tl))
    ...
    def test_scene_tl(self):
        tl_images = {
            "scene_tl_test": {"x": 338, "y": 200, "state": "red"},
            "tl_green_299_287_background": {"x": 287, "y": 299, "state": "green"},
            "tl_red_199_137_background": {"x": 137, "y": 199, "state": "red"},
            "tl_yellow_199_237_background": {"x": 237, "y": 199, "state": "yellow"},
        }

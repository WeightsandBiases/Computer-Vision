...
class Part1(unittest.TestCase):
    ...
    def test_optic_flow_LK(self):
        ...
        for i in range(3):
            ...
            img1 = cv2.imread(INPUT_DIR + f1, 0) / 255.0
            img2 = cv2.imread(INPUT_DIR + f2, 0) / 255.0

            u, v = ps4.optic_flow_lk(
                img1.copy(), img2.copy(), self.k_size, self.k_type, 1.0
            )
            ...
            error_msg = (
                "Average of U values in the area where there is "
            ...
            error_msg = (
                "Average of V values in the area where there is "
                "movement is greater than the allowed amount."
            )
...
class Part2(unittest.TestCase):
    def test_reduce(self):
        input_imgs = [
            "test_reduce1_img.npy",
            "test_reduce2_img.npy",
            "test_reduce3_img.npy",
        ]
        ref_imgs = [
            "test_reduce1_ref.npy",
            "test_reduce2_ref.npy",
        ...
        for i in range(3):
            ...
            self.assertTrue(correct, "Output does not match the reference " "solution.")

    def test_expand(self):
        input_imgs = [
            "test_expand1_img.npy",
            "test_expand2_img.npy",
            "test_expand3_img.npy",
        ]
        ref_imgs = [
            "test_expand1_ref.npy",
            "test_expand2_ref.npy",
    ...
    def test_gaussian_pyramid(self):
        ...
        ref_imgs = [
            "test_gauss1_pyr_ref.npy",
            "test_gauss2_pyr_ref.npy",
        ...
        for i in range(3):
            ...
            for l in range(len(g_pyr)):
                ...
                error_msg = "Value at level {} does not match the answer." "".format(l)

                self.assertTrue(correct, error_msg)

    def test_laplacian_pyramid(self):
        input_imgs = ["test_lapl1_pyr.npy", "test_lapl2_pyr.npy", "test_lapl3_pyr.npy"]
        ref_imgs = [
            "test_lapl1_pyr_ref.npy",
            "test_lapl2_pyr_ref.npy",
        ...
        for i in range(3):
            ...
            for l in range(levels[i]):
                ...
                error_msg = (
                    "Value at level {} does not match the answer. "
...
class Part3(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        self.input_imgs_1 = ["test_warp1.npy", "test_warp3.npy", "test_warp5.npy"]
        self.input_imgs_2 = ["test_warp2.npy", "test_warp4.npy", "test_warp6.npy"]
    ...
    def test_warp(self):
        ...
        for i in range(2):
            ...
            img1 = np.load(
                INPUT_DIR + f1, encoding="latin1", allow_pickle=True
            )  # Not used
            ...
            warped = ps4.warp(
                img2.copy(), u.copy(), v.copy(), cv2.INTER_CUBIC, cv2.BORDER_REFLECT101
            )
            ...
            error_msg = (
                "Center box average pixel value is greater than the "
            ...
            warped_without_center[r : 3 * r, c : 3 * c] = 0.0
            ...
            error_msg = (
                "Average of values outside the center box area are "
